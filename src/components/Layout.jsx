    ...
    <header className="sticky top-0 z-30 border-b border-cyan-100/30 bg-[#04162e]/82 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3 sm:px-6">
        <NavLink to="/" className="flex items-center gap-2 font-bold text-white">
          <span className="grid h-9 w-9 place-items-center rounded-xl bg-gradient-to-br from-emerald-400 to-cyan-500 text-[#06203a] shadow-lg shadow-cyan-500/30"><Activity size={20}/></span>
          <span className="hidden sm:block">StadiumPulse <span className="text-gold">AI</span></span>
        </NavLink>
